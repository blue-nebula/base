...
#endif
enum { CON_CHAT = CON_GAMESPECIFIC, CON_CHAT_WHISPER, CON_CHAT_TEAM, CON_EVENT, CON_GAME, CON_GAME_INFO, CON_FRAG, CON_MAX, CON_LO = CON_MESG, CON_HI = CON_SELF, CON_IMPORTANT = CON_SELF };
