...
namespace voicelines
{
    std::map<const int, voiceline> voiceline_list {
        ...
        {S_VL_HANGON,    voiceline("voice/hangon"   , 2, std::vector<std::string>{"hangon"})                                   },
    ...
    {
        int sound = -1;
        text += " "; // so e.g. "gno " can work even if you type "gno", was previously called absolute matching
